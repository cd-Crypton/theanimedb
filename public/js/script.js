...
<form id="search-form" class="w-full">
  <div class="relative flex items-center gap-2">
    ...
    <button type="submit" ${state.isLoading ? 'disabled' : ''}
      class="mr-2 flex-shrink-0 bg-blue-500 text-white p-3 rounded-full hover:bg-blue-600 disabled:opacity-50 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400">

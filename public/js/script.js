...
async function fetchHomeData() { /* ... same as before ... */ }
async function fetchSearchResults(page = 1) { /* ... same as before ... */ }
async function fetchAnimeDetails(animeId) { /* ... same as before ... */ }
async function handleEpisodeSelection(episodeId) { /* ... same as before ... */ }
    ...
    try {
        ...
        if (player && !player.isDisposed()) {
            ...
            player.on('error', () => {
                ...
                // Display the error inside the player
        ...
        console.error(err);
        // Display fetch errors inside the player too
        if (player && !player.isDisposed()) {
...
// --- Event Handlers ---
function handleSearchInput(query) { /* ... same as before ... */ }
function selectSuggestion(animeId) { /* ... same as before ... */ }
function handleSearchSubmit(e) { /* ... same as before ... */ }
function handlePageChange(dir) { /* ... same as before ... */ }
async function fetchSearchSuggestions(query) { /* ... same as before ... */ }
function handleSelectAnime(animeId) { /* ... same as before ... */ }
function handleGoHome() { /* ... same as before ... */ }
